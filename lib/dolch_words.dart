/// Dolch Sight Word List, grouped by category, for use in the word
/// match game. Sourced from Dolch_Sight_Word_List.txt.
library;

const Map<String, List<String>> dolchWordsByCategory = {
  'Pre-Primer': [
  ...
  'Third Grade': [
    ...
    'hurt', 'if', 'keep', 'kind', 'laugh', 'light', 'long', 'much',
  ...
  'Dolch Nouns': [
    ...
    'party', 'picture', 'pig', 'rabbit', 'rain', 'ring', 'robin',
    'Santa Claus', 'school', 'seed', 'sheep', 'shoe', 'sister', 'snow',
    'song', 'squirrel', 'stick', 'street', 'sun', 'table', 'thing', 'time',
    'top', 'toy', 'tree', 'watch', 'water', 'way', 'wind', 'window', 'wood',
  ],
};

/// All Dolch words combined into a single flat, de-duplicated list.
final List<String> allDolchWords =
    dolchWordsByCategory.values.expand((words) => words).toSet().toList();
